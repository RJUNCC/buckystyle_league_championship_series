...
class Commands(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.bot.tree.add_command(self.predict)

    @discord.app_commands.command(name='predict', description='Get prediction and stats for a player.')
    async def predict(self, interaction: discord.Interaction, player_name: str):
        await interaction.response.send_message(f"Fetching stats for {player_name}...")
        # Add your logic here
